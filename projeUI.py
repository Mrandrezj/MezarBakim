...
"}")
        ...
        self.label_5.setGeometry(QtCore.QRect(260, 10, 91, 31))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(50, 190, 131, 16))
        self.label_6.setObjectName("label_6")
        self.cw_tarih = QtWidgets.QCalendarWidget(self.centralwidget)
        self.cw_tarih.setGeometry(QtCore.QRect(250, 40, 321, 151))
        self.cw_tarih.setObjectName("cw_tarih")
        self.cw_odeme = QtWidgets.QCalendarWidget(self.centralwidget)
        self.cw_odeme.setGeometry(QtCore.QRect(40, 210, 312, 151))
        self.cw_odeme.setObjectName("cw_odeme")
        self.tw_bilgiler = QtWidgets.QTableWidget(self.centralwidget)
        self.tw_bilgiler.setGeometry(QtCore.QRect(40, 360, 721, 171))
        self.tw_bilgiler.setRowCount(1000)
        self.tw_bilgiler.setColumnCount(7)
        self.tw_bilgiler.setObjectName("tw_bilgiler")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(40, 550, 81, 16))
        self.label_7.setObjectName("label_7")
        self.lbl_kaysays = QtWidgets.QLabel(self.centralwidget)
        self.lbl_kaysays.setGeometry(QtCore.QRect(120, 550, 81, 16))
        self.lbl_kaysays.setText("")
        self.lbl_kaysays.setObjectName("lbl_kaysays")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(40, 40, 193, 126))
        ...
        self.cmbmezarlik = QtWidgets.QComboBox(self.layoutWidget)
        self.cmbmezarlik.setObjectName("cmbmezarlik")
        self.cmbmezarlik.addItem("")
        self.cmbmezarlik.addItem("")
        self.cmbmezarlik.addItem("")
        self.cmbmezarlik.addItem("")
        self.horizontalLayout_3.addWidget(self.cmbmezarlik)
        ...
        self.fiyat = QtWidgets.QSpinBox(self.layoutWidget)
        self.fiyat.setMaximum(9999)
        self.fiyat.setObjectName("fiyat")
        self.horizontalLayout_4.addWidget(self.fiyat)
        self.verticalLayout.addLayout(self.horizontalLayout_4)
        self.layoutWidget1 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget1.setGeometry(QtCore.QRect(590, 50, 190, 88))
        ...
        self.btn_guncelle = QtWidgets.QPushButton(self.layoutWidget1)
        self.btn_guncelle.setObjectName("btn_guncelle")
        self.verticalLayout_3.addWidget(self.btn_guncelle)
        self.btn_liste = QtWidgets.QPushButton(self.layoutWidget1)
        self.btn_liste.setObjectName("btn_liste")
        self.verticalLayout_3.addWidget(self.btn_liste)
        self.btn_cikis = QtWidgets.QPushButton(self.layoutWidget1)
        self.btn_cikis.setObjectName("btn_cikis")
        self.verticalLayout_3.addWidget(self.btn_cikis)
        self.horizontalLayout_5.addLayout(self.verticalLayout_3)
        self.layoutWidget2 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget2.setGeometry(QtCore.QRect(540, 320, 162, 22))
        ...
        self.total = QtWidgets.QLabel(self.layoutWidget2)
        self.total.setText("")
        self.total.setObjectName("total")
        self.horizontalLayout_6.addWidget(self.total)
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(690, 10, 101, 31))
        ...
        self.menuhakkinda_2 = QtWidgets.QAction(MainWindow)
        self.menuhakkinda_2.setObjectName("menuhakkinda_2")
        self.menuhakkinda.addAction(self.menuhakkinda_2)
        self.menubar.addAction(self.menuhakkinda.menuAction())

        self.retranslateUi(MainWindow)
        self.cmbmezarlik.setCurrentIndex(-1)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label_5.setText(_translate("MainWindow", "ÖLÜM TARİHİ :"))
        self.label_6.setText(_translate("MainWindow", "SON YAPILAN ÖDEME :"))
        self.label_7.setText(_translate("MainWindow", "KAYIT SAYISI :"))
        self.label.setText(_translate("MainWindow", "AD :"))
        self.label_2.setText(_translate("MainWindow", "SOYAD :"))
        self.label_3.setText(_translate("MainWindow", "MEZARLIK :"))
        self.cmbmezarlik.setItemText(0, _translate("MainWindow", "Andızlı"))
        self.cmbmezarlik.setItemText(1, _translate("MainWindow", "Uncalı"))
        self.cmbmezarlik.setItemText(2, _translate("MainWindow", "Kursunlu"))
        self.cmbmezarlik.setItemText(3, _translate("MainWindow", "Diger"))
        self.label_4.setText(_translate("MainWindow", "FİYAT :"))
        self.btn_ekle.setText(_translate("MainWindow", "KAYIT EKLE"))
        self.btn_sil.setText(_translate("MainWindow", "KAYIT SİL"))
        self.btn_ara.setText(_translate("MainWindow", "KAYIT ARA"))
        self.btn_guncelle.setText(_translate("MainWindow", "GÜNCELLE"))
        self.btn_liste.setText(_translate("MainWindow", "KAYIT LİSTELE"))
        self.btn_cikis.setText(_translate("MainWindow", "ÇIKIŞ"))
        self.label_8.setText(_translate("MainWindow", "TOPLAM GELİR :"))
        self.label_9.setText(_translate("MainWindow", "Produced by M.K."))
        self.menuhakkinda.setTitle(_translate("MainWindow", "Yardım"))
        self.menuhakkinda_2.setText(_translate("MainWindow", "Hakkında"))
